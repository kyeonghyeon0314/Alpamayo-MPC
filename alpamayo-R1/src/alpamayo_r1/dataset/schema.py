...
class AlpamayoSample:
    ...
    # --- A. GT 축 ---
    gt_future_xyz: np.ndarray         # (64, 3)    float32  로컬 ego 좌표계
    gt_future_rot: np.ndarray         # (64, 3, 3) float32  로컬 ego 좌표계
    gt_future_ego_states: np.ndarray  # (64, 5)    float32  [x, y, speed, yaw, lon_accel]

    # --- B. 입력 축 (ego history) ---
    ego_history_xyz: np.ndarray         # (16, 3)    float32  로컬 ego 좌표계
    ego_history_rot: np.ndarray         # (16, 3, 3) float32  로컬 ego 좌표계
